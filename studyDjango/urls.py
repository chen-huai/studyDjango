...
urlpatterns = [
    ...
    re_path(r'^(?i)getMethod/$', views.getMethod),
    re_path(r'^(?i)postMethod/$', views.postMethod),
    re_path(r'^(?i)bodyMethod/$', views.bodyMethod),
    re_path(r'^(?i)pathMethod/$', views.pathMethod),
    re_path(r'^(?i)httpRes/$', views.httpRes),
    re_path(r'^(?i)renderMethod/$', views.renderMethod),
    re_path(r'redirectMethod/$', views.redirectMethod),
